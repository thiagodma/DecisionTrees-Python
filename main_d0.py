...
clf_QP_27 = Classifier(data_QP_27, max_depth=None,splitter='best',min_samples_leaf=6263,criterion='gini')
clf_QP_27.fit_tree()
...
clf_QP_32 = Classifier(data_QP_32, max_depth=None,splitter='best',min_samples_leaf=708,criterion='gini')
clf_QP_32.fit_tree()
...
clf_QP_37 = Classifier(data_QP_37, max_depth=None,splitter='best',min_samples_leaf=405,criterion='gini')
clf_QP_37.fit_tree()
