	...
	*/
	...
	if (isIntra == false)
	{
		...
		if (uiLevel == 0)
		{
			...
			switch (uiQP)
			{
			case 23: uiClassification = xdecide_depth0_QP23_v3(dFeatures);
				     break;
			case 24: uiClassification = xdecide_depth0_QP24_v3(dFeatures);
				     break;
			case 25: uiClassification = xdecide_depth0_QP25_v3(dFeatures);
				     break;
			case 28: uiClassification = xdecide_depth0_QP28_v3(dFeatures);
				     break;
			case 29: uiClassification = xdecide_depth0_QP29_v3(dFeatures);
				     break;
			case 30: uiClassification = xdecide_depth0_QP30_v3(dFeatures);
				     break;
			case 33: uiClassification = xdecide_depth0_QP33_v3(dFeatures);
				     break;
			case 34: uiClassification = xdecide_depth0_QP34_v3(dFeatures);
			 	     break;
			case 35: uiClassification = xdecide_depth0_QP35_v3(dFeatures);
				     break;
			case 38: uiClassification = xdecide_depth0_QP38_v3(dFeatures);
				     break;
			case 39: uiClassification = xdecide_depth0_QP39_v3(dFeatures);
				     break;
			case 40: uiClassification = xdecide_depth0_QP40_v3(dFeatures);
				     break;
		...
		if (uiLevel == 1)
		{
			...
			switch (uiQP)
			{
			case 23: uiClassification = xdecide_depth1_QP23_v3(dFeatures);
				break;
			case 24: uiClassification = xdecide_depth1_QP24_v3(dFeatures);
				break;
			case 25: uiClassification = xdecide_depth1_QP25_v3(dFeatures);
				break;
			case 28: uiClassification = xdecide_depth1_QP28_v3(dFeatures);
				break;
			case 29: uiClassification = xdecide_depth1_QP29_v3(dFeatures);
				break;
			case 30: uiClassification = xdecide_depth1_QP30_v3(dFeatures);
				break;
			case 33: uiClassification = xdecide_depth1_QP33_v3(dFeatures);
				break;
			case 34: uiClassification = xdecide_depth1_QP34_v3(dFeatures);
				break;
			case 35: uiClassification = xdecide_depth1_QP35_v3(dFeatures);
				break;
			case 38: uiClassification = xdecide_depth1_QP38_v3(dFeatures);
				break;
			case 39: uiClassification = xdecide_depth1_QP39_v3(dFeatures);
				break;
			case 40: uiClassification = xdecide_depth1_QP40_v3(dFeatures);
				break;
			default: printf("Não existe uma árvore estática definida para este valor de QP");
			}
		}
...
if(dFeatures[6] <= 0.28)
{
    ...
    else
    {
        if(dFeatures[8] <= 0.03)
        {
            if(dFeatures[5] <= 65.50)
            {
                if(dFeatures[4] <= 112.00)
                {
                    if(dFeatures[1] <= 692.42)
                    {
                        return 0;
                    }
                    else
...
else
{
    ...
    else
    {
        ...
        {
            if(dFeatures[1] <= 111.72)
            {
                if(dFeatures[4] <= 35.00)
                {
                    if(dFeatures[7] <= 0.03)
                    {
                        return 1;
    ...
    if(dFeatures[8] <= 0.03)
    {
        if(dFeatures[6] <= 0.34)
        {
            if(dFeatures[7] <= 0.03)
            {
                ...
                {
                    if(dFeatures[5] <= 30.00)
                    {
                        if(dFeatures[4] <= 52.50)
                        {
            ...
            else
            {
                ...
                {
                    if(dFeatures[4] <= 53.50)
                    {
                        if(dFeatures[0] <= 515.85)
                        {
                            return 0;
                        }
                        else
        ...
        if(dFeatures[8] <= 0.16)
        {
            ...
            else
            {
                ...
                else
                {
                    if(dFeatures[7] <= 0.84)
                    {
                        if(dFeatures[0] <= 17.71)
                        {
                            if(dFeatures[1] <= 52.70)
                            {
                                return 0;
                            }
                            else
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    if(dFeatures[8] <= 0.28)
                    {
                        if(dFeatures[0] <= 35.57)
                        {
                            if(dFeatures[0] <= 35.52)
                            {
                                return 0;
                            }
                            else
    ...
    if(dFeatures[6] <= 0.78)
    {
        if(dFeatures[8] <= 0.03)
        {
            if(dFeatures[1] <= 63.25)
            {
                ...
                {
                    if(dFeatures[1] <= 15.58)
                    {
                        if(dFeatures[9] <= 0.28)
                        {
                            if(dFeatures[4] <= 43.00)
                            {
                                return 0;
                            }
                            else
    ...
    else
    {
        if(dFeatures[6] <= 0.91)
        {
            if(dFeatures[8] <= 0.03)
            {
                ...
                {
                    if(dFeatures[1] <= 314.39)
                    {
                        return 0;
                    }
                    else
                    {
                        if(dFeatures[1] <= 457.58)
                        {
                            if(dFeatures[0] <= 152.87)
                            {
                                return 0;
                            }
                            else
    ...
    if(dFeatures[8] <= 0.03)
    {
        if(dFeatures[6] <= 0.28)
        {
            ...
            else
            {
                ...
                {
                    if(dFeatures[0] <= 113.04)
                    {
                        if(dFeatures[1] <= 337.46)
                        {
                            if(dFeatures[0] <= 20.68)
                            {
                                return 1;
                            }
                            else
    ...
    else
    {
        ...
        else
        {
            if(dFeatures[8] <= 0.16)
            {
                ...
                {
                    if(dFeatures[0] <= 23.65)
                    {
                        if(dFeatures[5] <= 38.50)
                        {
                            if(dFeatures[0] <= 23.11)
                            {
                                return 0;
                            }
                            else
...
else
{
    ...
    else
    {
        if(dFeatures[8] <= 0.03)
        {
            if(dFeatures[6] <= 0.91)
            {
                if(dFeatures[1] <= 120.06)
                {
                    if(dFeatures[6] <= 0.84)
                    {
                        if(dFeatures[5] <= 32.50)
                        {
                            if(dFeatures[0] <= 172.04)
                            {
                                return 1;
                            }
                            else
                ...
                else
                {
                    if(dFeatures[2] <= 0.60)
                    {
                        if(dFeatures[0] <= 549.60)
                        {
                            if(dFeatures[0] <= 33.40)
                            {
                                return 0;
                            }
                            else
        ...
        else
        {
            ...
            else
            {
                if(dFeatures[4] <= 2.50)
                {
                    ...
                    {
                        if(dFeatures[1] <= 322.95)
                        {
                            return 0;
                        }
                        else
                        {
                            if(dFeatures[0] <= 121.77)
                            {
                                return 1;
                            }
                            else
    ...
    if(dFeatures[6] <= 0.12)
    {
        if(dFeatures[8] <= 0.12)
        {
            if(dFeatures[5] <= 0.50)
            {
                ...
                {
                    if(dFeatures[0] <= 56.63)
                    {
                        if(dFeatures[3] <= 10.33)
                        {
                            return 1;
                        }
                        else
        ...
        else
        {
            ...
            else
            {
                if(dFeatures[5] <= 11.50)
                {
                    ...
                    {
                        if(dFeatures[0] <= 111.82)
                        {
                            if(dFeatures[0] <= 24.19)
                            {
                                return 0;
                            }
                            else
                ...
                else
                {
                    ...
                    {
                        if(dFeatures[0] <= 2957.65)
                        {
                            if(dFeatures[0] <= 1059.54)
                            {
                                return 1;
                            }
                            else
...
else
{
    ...
    {
        if(dFeatures[4] <= 112.50)
        {
            if(dFeatures[5] <= 87.50)
            {
                if(dFeatures[5] <= 37.50)
                {
                    if(dFeatures[8] <= 0.12)
                    {
                        if(dFeatures[0] <= 47.83)
                        {
                            if(dFeatures[1] <= 6.67)
                            {
                                return 1;
            ...
            else
            {
                if(dFeatures[9] <= 0.12)
                {
                    if(dFeatures[3] <= 0.82)
                    {
                        if(dFeatures[0] <= 46.03)
                        {
                            if(dFeatures[1] <= 135.56)
                            {
                                return 0;
                            }
                            else
                ...
                {
                    if(dFeatures[1] <= 470.28)
                    {
                        if(dFeatures[1] <= 469.60)
                        {
                            if(dFeatures[3] <= 0.01)
                            {
                                return 1;
        ...
        else
        {
            if(dFeatures[8] <= 0.62)
            {
                if(dFeatures[3] <= 2.07)
                {
                    if(dFeatures[4] <= 338.50)
                    {
                        if(dFeatures[5] <= 141.50)
                        {
                            return 1;
                        }
                        else
                ...
                else
                {
                    ...
                    {
                        if(dFeatures[1] <= 5933.79)
                        {
                            if(dFeatures[5] <= 76.50)
                            {
                                return 1;
                            }
                            else
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if(dFeatures[0] <= 524.80)
                        {
                            return 1;
                        }
                        else
                        {
                            if(dFeatures[3] <= 10.13)
                            {
                                return 0;
                            }
                            else
...
else
{
    if(dFeatures[8] <= 0.62)
    {
        if(dFeatures[4] <= 311.50)
        {
            if(dFeatures[8] <= 0.38)
            {
                if(dFeatures[4] <= 114.50)
                {
            ...
            if(dFeatures[3] <= 0.00)
            {
                if(dFeatures[6] <= 0.12)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if(dFeatures[1] <= 1164.00)
                            {
                                if(dFeatures[0] <= 5183.14)
                                {
                ...
                if(dFeatures[5] <= 4.50)
                {
                    ...
                    else
                    {
                        if(dFeatures[2] <= 0.40)
                        {
                            ...
                            {
                                if(dFeatures[0] <= 247.63)
                                {
                                    if(dFeatures[0] <= 240.73)
                                    {
                                        return 0;
                                    }
                                    else
                        ...
                        else
                        {
                            if(dFeatures[3] <= 0.00)
                            {
                                if(dFeatures[0] <= 294.68)
                                {
                                    if(dFeatures[0] <= 170.71)
                                    {
                                        return 0;
                                    }
                                    else
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(dFeatures[3] <= 10.23)
                                {
                                    if(dFeatures[1] <= 460.85)
                                    {
                                        return 1;
                                    }
                                    else
        ...
        else
        {
            if(dFeatures[0] <= 1.01)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        if(dFeatures[2] <= 7.58)
                        {
                            if(dFeatures[5] <= 53.50)
                            {
                                if(dFeatures[0] <= 0.10)
                                {
                                    if(dFeatures[4] <= 50.50)
                                    {
                                        return 0;
                                    }
                                    else
            ...
            else
            {
                if(dFeatures[6] <= 0.12)
                {
                    ...
                    {
                        if(dFeatures[0] <= 10.75)
                        {
                            if(dFeatures[0] <= 7.56)
                            {
                                if(dFeatures[5] <= 63.50)
                                {
                                    if(dFeatures[1] <= 15.32)
                                    {
                                        return 0;
                                    }
                                    else
    ...
    else
    {
        if(dFeatures[4] <= 2.50)
        {
                ...
                else
                {
                    ...
                    else
                    {
                        if(dFeatures[2] <= 1.42)
                        {
                            ...
                            {
                                if(dFeatures[0] <= 491.82)
                                {
                                    return 0;
                                }
                                else
                                {
                                    if(dFeatures[0] <= 673.65)
                                    {
                                        return 0;
                                    }
                                    else
                        ...
                        else
                        {
                            ...
                            {
                                if(dFeatures[0] <= 26.43)
                                {
                                    return 1;
                                }
                                else
                                {
                                    if(dFeatures[0] <= 27.53)
                                    {
                                        return 0;
                                    }
                                    else
            ...
            else
            {
                if(dFeatures[0] <= 0.67)
                {
                    ...
                    else
                    {
                        if(dFeatures[2] <= 7.43)
                        {
                            if(dFeatures[0] <= 0.13)
                            {
                                if(dFeatures[3] <= 10.39)
                                {
                                    if(dFeatures[3] <= 10.34)
                                    {
                                        return 0;
                                    }
                                    else
                ...
                {
                    if(dFeatures[1] <= 59.60)
                    {
                        if(dFeatures[1] <= 0.13)
                        {
                            if(dFeatures[0] <= 3083.66)
                            {
                                if(dFeatures[3] <= 0.00)
                                {
                                    if(dFeatures[0] <= 0.95)
                    ...
                    {
                        if(dFeatures[1] <= 2483.33)
                        {
                            if(dFeatures[1] <= 2281.74)
                            {
                                if(dFeatures[0] <= 105.23)
                                {
                                    if(dFeatures[0] <= 58.81)
                                    {
                                        return 0;
                                    }
                                    else
        ...
        else
        {
            if(dFeatures[7] <= 0.12)
            {
                ...
                else
                {
                    if(dFeatures[5] <= 9.00)
                    {
                        if(dFeatures[0] <= 48.00)
                        {
                            return 1;
                        }
                        else
                        {
                            if(dFeatures[0] <= 145.94)
                            {
                                return 0;
                            }
                            else
                ...
                if(dFeatures[5] <= 12.50)
                {
                    if(dFeatures[5] <= 7.50)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(dFeatures[1] <= 461.85)
                                {
                                    return 0;
                                }
                                else
                                {
                                    if(dFeatures[1] <= 566.80)
                                    {
                                        return 1;
                                    }
                                    else
    ...
    if(dFeatures[8] <= 0.38)
    {
        ...
        else
        {
            ...
            else
            {
                if(dFeatures[3] <= 1.56)
                {
                    if(dFeatures[5] <= 55.50)
                    {
                        if(dFeatures[0] <= 60.36)
                        {
                            if(dFeatures[2] <= 0.29)
                            {
                                if(dFeatures[2] <= 0.13)
                    ...
                    {
                        if(dFeatures[0] <= 209.70)
                        {
                            if(dFeatures[9] <= 0.62)
                            {
                                if(dFeatures[0] <= 65.07)
                                {
                                    if(dFeatures[0] <= 63.81)
                                    {
                                        return 0;
                                    }
                                    else
                ...
                else
                {
                    if(dFeatures[5] <= 67.50)
                    {
                        if(dFeatures[0] <= 205.61)
                        {
                            if(dFeatures[2] <= 6.30)
                            {
                                if(dFeatures[0] <= 177.67)
                                {
                                    if(dFeatures[7] <= 0.62)
                                    {
                                        return 0;
                        ...
                        else
                        {
                            ...
                            {
                                if(dFeatures[0] <= 1132.16)
                                {
                                    if(dFeatures[4] <= 72.50)
                                    {
                                        return 0;
                                    }
                                    else
    ...
    else
    {
        if(dFeatures[8] <= 0.62)
        {
            ...
            else
            {
                if(dFeatures[3] <= 0.76)
                {
                    ...
                    else
                    {
                        if(dFeatures[5] <= 36.50)
                        {
                            ...
                            {
                                if(dFeatures[0] <= 76.83)
                                {
                                    if(dFeatures[1] <= 20.31)
                                    {
                                        return 0;
                                    }
                                    else
                ...
                {
                    if(dFeatures[5] <= 50.50)
                    {
                        if(dFeatures[6] <= 0.12)
                        {
                            if(dFeatures[0] <= 146.40)
                            {
                                if(dFeatures[4] <= 40.50)
                                {
                                    if(dFeatures[3] <= 2.40)
                    ...
                    else
                    {
                        if(dFeatures[2] <= 2.84)
                        {
                            if(dFeatures[5] <= 54.50)
                            {
                                if(dFeatures[4] <= 132.00)
                                {
                                    if(dFeatures[4] <= 100.50)
                                    {
                                        return 0;
                                    }
                                    else
                        ...
                        {
                            if(dFeatures[5] <= 64.50)
                            {
                                if(dFeatures[5] <= 51.50)
                                {
                                    if(dFeatures[4] <= 59.00)
                                    {
                                        return 0;
                                    }
                                    else
                            ...
                            {
                                if(dFeatures[1] <= 2759.25)
                                {
                                    if(dFeatures[4] <= 136.00)
                                    {
                                        return 0;
                                    }
                                    else
                ...
                if(dFeatures[3] <= 0.80)
                {
                    if(dFeatures[5] <= 10.50)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(dFeatures[0] <= 23.41)
                                {
                                    if(dFeatures[0] <= 11.31)
                                    {
                                        return 0;
                                    }
                                    else
                ...
                else
                {
                    if(dFeatures[7] <= 0.12)
                    {
                        if(dFeatures[9] <= 0.12)
                        {
                            if(dFeatures[2] <= 8.51)
                            {
                                if(dFeatures[0] <= 702.76)
                                {
                                    if(dFeatures[3] <= 10.22)
                                    {
                                        return 0;
                                    }
                                    else
                        ...
                        else
                        {
                            if(dFeatures[3] <= 4.99)
                            {
                                if(dFeatures[1] <= 199.34)
                                {
                                    if(dFeatures[1] <= 86.09)
                                    {
                                        return 0;
                                    }
                                    else
                            ...
                            {
                                if(dFeatures[1] <= 428.56)
                                {
                                    if(dFeatures[4] <= 25.00)
                                    {
                                        return 0;
                                    }
                                    else
            ...
            else
            {
                if(dFeatures[8] <= 0.88)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if(dFeatures[4] <= 151.00)
                            {
                                if(dFeatures[5] <= 29.50)
                                {
                                    if(dFeatures[0] <= 13.30)
                                    {
                                        return 1;
                                    }
                                    else
                ...
                else
                {
                    if(dFeatures[3] <= 10.13)
                    {
                        ...
                        {
                            if(dFeatures[1] <= 3878.63)
                            {
                                if(dFeatures[0] <= 411.87)
                                {
                                    return 0;
                                }
                                else
    ...
    else
    {
        if(dFeatures[5] <= 53.50)
        {
            if(dFeatures[2] <= 0.44)
            {
                ...
                {
                    if(dFeatures[4] <= 54.50)
                    {
                        if(dFeatures[0] <= 38.22)
                        {
                            if(dFeatures[3] <= 0.77)
                            {
                                return 0;
        ...
        else
        {
            if(dFeatures[4] <= 114.50)
            {
                if(dFeatures[3] <= 0.76)
                {
                    if(dFeatures[1] <= 16.67)
                    {
                        if(dFeatures[0] <= 0.09)
                        {
                            if(dFeatures[5] <= 73.00)
                            {
                                return 0;
                            }
                            else
        ...
        if(dFeatures[2] <= 0.77)
        {
            if(dFeatures[5] <= 20.50)
            {
                ...
                else
                {
                    ...
                    {
                        if(dFeatures[0] <= 88.67)
                        {
                            if(dFeatures[1] <= 14.08)
                            {
                                return 0;
                            }
                            else
        ...
        else
        {
            ...
            else
            {
                if(dFeatures[2] <= 2.84)
                {
                    if(dFeatures[4] <= 112.50)
                    {
                        if(dFeatures[0] <= 121.66)
                        {
                            if(dFeatures[1] <= 77.52)
                            {
                                return 0;
                            }
                            else
...
if(dFeatures[8] <= 0.12)
{
    if(dFeatures[7] <= 0.12)
    {
        if(dFeatures[6] <= 0.62)
        {
            ...
            {
                if(dFeatures[4] <= 36.00)
                {
                    return 0;
                }
                else
                {
                    if(dFeatures[4] <= 41.50)
                    {
                        return 1;
                    }
                    else
        ...
        else
        {
            ...
            {
                if(dFeatures[4] <= 17.00)
                {
                    if(dFeatures[0] <= 271.76)
                    {
                        if(dFeatures[2] <= 0.00)
                        {
                            return 0;
    ...
    if(dFeatures[4] <= 3.50)
    {
        if(dFeatures[7] <= 0.62)
        {
            if(dFeatures[8] <= 0.38)
            {
                ...
                else
                {
                    ...
                    {
                        if(dFeatures[1] <= 2257.31)
                        {
                            if(dFeatures[1] <= 1209.98)
                            {
                                return 0;
                            }
                            else
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if(dFeatures[0] <= 56.67)
                    {
                        if(dFeatures[1] <= 25.03)
                        {
                            if(dFeatures[1] <= 23.78)
                            {
                                return 1;
                            }
                            else
...
if(dFeatures[8] <= 0.12)
{
    ...
    else
    {
        if(dFeatures[3] <= 0.00)
        {
            ...
            {
                if(dFeatures[0] <= 376.51)
                {
                    if(dFeatures[0] <= 15.93)
                    {
                        return 0;
                    }
                    else
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if(dFeatures[0] <= 262.84)
                        {
                            if(dFeatures[0] <= 125.26)
                            {
                                return 0;
                            }
                            else
    ...
    else
    {
        ...
        else
        {
            if(dFeatures[1] <= 0.13)
            {
                ...
                {
                    if(dFeatures[0] <= 1209.40)
                    {
                        if(dFeatures[0] <= 42.89)
                        {
                            return 0;
                        }
                        else
    ...
    if(dFeatures[8] <= 0.38)
    {
        ...
        else
        {
            if(dFeatures[5] <= 2.50)
            {
                ...
                {
                    if(dFeatures[0] <= 52.47)
                    {
                        if(dFeatures[0] <= 24.55)
                        {
                            return 0;
                        }
                        else
        ...
        else
        {
            ...
            else
            {
                if(dFeatures[6] <= 0.12)
                {
                    ...
                    {
                        if(dFeatures[0] <= 708.12)
                        {
                            if(dFeatures[1] <= 68.55)
                            {
                                return 0;
                            }
                            else
...
if(dFeatures[8] <= 0.12)
{
    if(dFeatures[3] <= 0.00)
    {
        if(dFeatures[6] <= 0.62)
        {
            ...
            {
                if(dFeatures[0] <= 101.56)
                {
                    if(dFeatures[2] <= 10.12)
                    {
                        return 1;
                    }
                    else
