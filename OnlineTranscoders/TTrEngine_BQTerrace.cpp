    ...
    if(dFeatures[3] <= 0.00)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if(dFeatures[0] <= 2746.44)
                    {
                        return 1;
                    }
                    else
                    {
                        if(dFeatures[0] <= 2769.00)
                        {
                            return 0;
                        }
                        else
