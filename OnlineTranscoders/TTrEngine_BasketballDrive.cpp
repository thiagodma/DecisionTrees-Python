	...
	*/
	...
	if (isIntra == false)
	{
		...
		UInt uiClassification;
            ...
            if (m_uiCurrFrame <=12){ //emulating online training
                uiClassification = 1;
                //printf("Frame: %d, training.", "%d\n", m_uiCurrFrame);
            }
            else
            {
    ...
    if(dFeatures[3] <= 0.00)
    {
        ...
        else
        {
            ...
            else
            {
                if(dFeatures[7] <= 0.09)
                {
                    if(dFeatures[4] <= 111.50)
                    {
                        if(dFeatures[1] <= 573.36)
                        {
                            return 0;
                        }
                        else
    ...
    else
    {
        if(dFeatures[6] <= 0.28)
        {
            ...
            else
            {
                ...
                {
                    if(dFeatures[3] <= 10.03)
                    {
                        if(dFeatures[0] <= 2325.19)
                        {
                            return 1;
                        }
                        else
        ...
        else
        {
            if(dFeatures[7] <= 0.09)
            {
                if(dFeatures[0] <= 3137.54)
                {
                    if(dFeatures[4] <= 92.00)
                    {
                        if(dFeatures[0] <= 0.42)
                        {
                            return 0;
            ...
            {
                if(dFeatures[1] <= 608.57)
                {
                    if(dFeatures[1] <= 12.66)
                    {
                        if(dFeatures[1] <= 9.53)
                        {
                            return 0;
...
else
{
    ...
    else
    {
        if(dFeatures[3] <= 0.00)
        {
            ...
            {
                if(dFeatures[0] <= 19.59)
                {
                    if(dFeatures[1] <= 16.76)
                    {
                        if(dFeatures[2] <= 0.00)
                        {
                            return 1;
        ...
        else
        {
            if(dFeatures[6] <= 0.59)
            {
                if(dFeatures[0] <= 689.23)
                {
                    if(dFeatures[3] <= 0.00)
                    {
                        if(dFeatures[0] <= 336.05)
                        {
                            return 0;
                        }
                        else
    ...
    if(dFeatures[8] <= 0.12)
    {
        ...
        else
        {
                ...
                if(dFeatures[4] <= 0.50)
                {
                    if(dFeatures[3] <= 0.02)
                    {
                        if(dFeatures[3] <= 0.00)
                        {
                            ...
                            {
                                if(dFeatures[0] <= 3946.05)
                                {
                                    if(dFeatures[0] <= 831.05)
                                    {
                                        return 1;
                                    }
                                    else
                ...
                else
                {
                    if(dFeatures[4] <= 31.50)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(dFeatures[1] <= 323.10)
                                {
                                    if(dFeatures[1] <= 98.83)
                                    {
                                        return 1;
                                    }
                                    else
            ...
            else
            {
                ...
                {
                    if(dFeatures[0] <= 960.26)
                    {
                        return 1;
                    }
                    else
                    {
                        if(dFeatures[0] <= 961.09)
                        {
                            return 0;
                        }
                        else
        ...
        if(dFeatures[2] <= 0.00)
        {
                ...
                else
                {
                    if(dFeatures[3] <= 0.00)
                    {
                        if(dFeatures[2] <= 0.00)
                        {
                            ...
                            {
                                if(dFeatures[1] <= 1560.47)
                                {
                                    return 0;
                                }
                                else
                                {
                                    if(dFeatures[0] <= 3262.25)
                                    {
                                        return 1;
                                    }
                                    else
            ...
            else
            {
                if(dFeatures[2] <= 0.00)
                {
                    if(dFeatures[4] <= 41.50)
                    {
                        if(dFeatures[5] <= 20.50)
                        {
                            ...
                            {
                                if(dFeatures[0] <= 97.23)
                                {
                                    return 1;
                                }
                                else
                                {
                                    if(dFeatures[0] <= 149.02)
                                    {
                                        return 0;
                                    }
                                    else
                ...
                else
                {
                    ...
                    {
                        if(dFeatures[0] <= 54.10)
                        {
                            if(dFeatures[2] <= 0.00)
                            {
                                if(dFeatures[4] <= 52.00)
                                {
                                    if(dFeatures[0] <= 37.27)
                                    {
                                        return 1;
                                    }
                                    else
                ...
                if(dFeatures[7] <= 0.62)
                {
                    ...
                    else
                    {
                        if(dFeatures[4] <= 10.50)
                        {
                            if(dFeatures[8] <= 0.62)
                            {
                                if(dFeatures[1] <= 178.73)
                                {
                                    if(dFeatures[0] <= 31.49)
                                    {
                                        return 1;
                                    }
                                    else
                ...
                else
                {
                    ...
                    else
                    {
                        if(dFeatures[3] <= 10.50)
                        {
                            ...
                            {
                                if(dFeatures[0] <= 397.01)
                                {
                                    if(dFeatures[0] <= 12.29)
                                    {
                                        return 1;
                                    }
                                    else
    ...
    if(dFeatures[5] <= 44.50)
    {
        if(dFeatures[2] <= 0.00)
        {
            if(dFeatures[5] <= 26.50)
            {
                ...
                {
                    if(dFeatures[0] <= 29.76)
                    {
                        if(dFeatures[0] <= 23.97)
                        {
                            if(dFeatures[2] <= 0.00)
                            {
                                if(dFeatures[2] <= 0.00)
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(dFeatures[0] <= 650.72)
                                {
                                    if(dFeatures[0] <= 147.61)
                                    {
                                        return 1;
                                    }
                                    else
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if(dFeatures[0] <= 1165.48)
                            {
                                if(dFeatures[1] <= 828.19)
                                {
                                    if(dFeatures[1] <= 365.60)
                                    {
                                        return 1;
                                    }
                                    else
                ...
                else
                {
                    if(dFeatures[2] <= 8.65)
                    {
                        ...
                        else
                        {
                            if(dFeatures[3] <= 3.92)
                            {
                                if(dFeatures[1] <= 1906.46)
                                {
                                    if(dFeatures[0] <= 160.21)
                                    {
                                        return 1;
                                    }
                                    else
                    ...
                    {
                        if(dFeatures[0] <= 28.72)
                        {
                            if(dFeatures[4] <= 63.50)
                            {
                                if(dFeatures[2] <= 9.96)
                                {
                                    if(dFeatures[4] <= 44.50)
                        ...
                        {
                            if(dFeatures[0] <= 178.00)
                            {
                                return 1;
                            }
                            else
                            {
                                if(dFeatures[0] <= 242.93)
                                {
                                    if(dFeatures[2] <= 9.75)
                                    {
                                        return 0;
                ...
                if(dFeatures[3] <= 9.52)
                {
                    ...
                    else
                    {
                        if(dFeatures[5] <= 41.50)
                        {
                            ...
                            {
                                if(dFeatures[1] <= 38.10)
                                {
                                    if(dFeatures[1] <= 13.02)
                                    {
                                        return 0;
                                    }
                                    else
        ...
        if(dFeatures[2] <= 0.30)
        {
            if(dFeatures[0] <= 256.02)
            {
                if(dFeatures[3] <= 0.03)
                {
                    if(dFeatures[8] <= 0.38)
                    {
                        if(dFeatures[7] <= 0.88)
                        {
                            if(dFeatures[0] <= 24.17)
                            {
                                if(dFeatures[6] <= 0.12)
                                {
                                    if(dFeatures[1] <= 21.65)
                                    {
                                        return 1;
                                    }
                                    else
                ...
                {
                    if(dFeatures[1] <= 293.03)
                    {
                        if(dFeatures[4] <= 356.00)
                        {
                            return 0;
                        }
                        else
                        {
                            if(dFeatures[5] <= 111.00)
                            {
                                return 1;
                            }
                            else
            ...
            else
            {
                ...
                else
                {
                    if(dFeatures[8] <= 0.62)
                    {
                        if(dFeatures[0] <= 3326.72)
                        {
                            if(dFeatures[1] <= 1643.44)
                            {
                                if(dFeatures[3] <= 0.11)
                                {
                                    if(dFeatures[3] <= 0.08)
                            ...
                            {
                                if(dFeatures[1] <= 2051.99)
                                {
                                    return 0;
                                }
                                else
                                {
                                    if(dFeatures[0] <= 1804.39)
                                    {
                                        return 1;
                                    }
                                    else
        ...
        else
        {
            ...
            else
            {
                if(dFeatures[2] <= 8.98)
                {
                    ...
                    {
                        if(dFeatures[4] <= 101.50)
                        {
                            if(dFeatures[6] <= 0.12)
                            {
                                if(dFeatures[0] <= 43.04)
                                {
                                    return 1;
                                }
                                else
                ...
                {
                    if(dFeatures[1] <= 869.18)
                    {
                        if(dFeatures[0] <= 150.16)
                        {
                            if(dFeatures[1] <= 144.06)
                            {
                                if(dFeatures[3] <= 9.97)
                                {
                                    if(dFeatures[4] <= 91.00)
                                    {
                                        return 1;
                                    }
                                    else
...
else
{
    if(dFeatures[5] <= 17.50)
    {
        if(dFeatures[3] <= 0.03)
        {
            ...
            else
            {
                if(dFeatures[2] <= 1.92)
                {
                    if(dFeatures[1] <= 7129.27)
                    {
                        if(dFeatures[0] <= 732.17)
                        {
                            return 1;
                        }
                        else
    ...
    else
    {
        if(dFeatures[5] <= 26.50)
        {
            ...
            {
                if(dFeatures[0] <= 322.90)
                {
                    if(dFeatures[1] <= 14.10)
                    {
                        if(dFeatures[0] <= 4.35)
                        {
                            return 0;
        ...
        else
        {
            ...
            {
                if(dFeatures[0] <= 3530.98)
                {
                    if(dFeatures[0] <= 431.19)
                    {
                        if(dFeatures[3] <= 10.46)
                        {
                            return 0;
