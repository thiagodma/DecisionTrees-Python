...
else
{
    if(dFeatures[4] <= 0.91)
    {
        ...
        else
        {
            if(dFeatures[1] <= 0.10)
            {
                if(dFeatures[0] <= 197.20)
                {
                    if(dFeatures[0] <= 46.93)
                    {
                        return 1;
                    }
                    else
        ...
        else
        {
            if(dFeatures[1] <= 0.27)
            {
                if(dFeatures[1] <= 0.00)
                {
                    ...
                    {
                        if(dFeatures[0] <= 179.46)
                        {
                            if(dFeatures[0] <= 104.88)
                            {
                                if(dFeatures[5] <= 0.41)
                                {
                                    if(dFeatures[5] <= 0.28)
                ...
                if(dFeatures[3] <= 3.50)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                if(dFeatures[0] <= 16.80)
                                {
                                    return 0;
                                }
                                else
                                {
                                    if(dFeatures[0] <= 19.57)
                                    {
                                        return 1;
                                    }
                                    else
    ...
    if(dFeatures[4] <= 0.97)
    {
        ...
        else
        {
            ...
            else
            {
                if(dFeatures[1] <= 0.98)
                {
                    if(dFeatures[0] <= 52.72)
                    {
                        if(dFeatures[0] <= 49.10)
                        {
                            return 1;
                        }
                        else
...
{
if(dFeatures[1] <= 38.50)
{
    if(dFeatures[1] <= 20.50)
    {
        if(dFeatures[1] <= 10.50)
        {
            return 0;
        }
        else
...
{
    if(dFeatures[1] <= 53.50)
    {
        if(dFeatures[2] <= 0.88)
        {
            if(dFeatures[1] <= 47.50)
            {
                return 0;
            }
            else
