...
clf_QP_22 = Classifier(data_QP_22,max_depth=None,splitter='best',min_samples_leaf=607,criterion='gini')
clf_QP_22.fit_tree()
...
clf_QP_27 = Classifier(data_QP_27, max_depth=None,splitter='best',min_samples_leaf=102,criterion='gini')
clf_QP_27.fit_tree()
...
clf_QP_32 = Classifier(data_QP_32, max_depth=None,splitter='best',min_samples_leaf=5152,criterion='gini')
clf_QP_32.fit_tree()
