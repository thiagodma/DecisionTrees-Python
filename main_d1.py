...
clf_QP_22 = Classifier(data_QP_22,max_depth=None,splitter='best',min_samples_leaf=59,criterion='entropy')
clf_QP_22.fit_tree()
...
clf_QP_27 = Classifier(data_QP_27, max_depth=None,splitter='random',min_samples_leaf=3593,criterion='gini')
clf_QP_27.fit_tree()
...
clf_QP_32 = Classifier(data_QP_32, max_depth=None,splitter='best',min_samples_leaf=464,criterion='entropy')
clf_QP_32.fit_tree()
...
clf_QP_37 = Classifier(data_QP_37, max_depth=None,splitter='random',min_samples_leaf=59,criterion='entropy')
clf_QP_37.fit_tree()
