...
clf_QP_22 = Classifier(data_QP_22,max_depth=4,splitter='best',min_samples_leaf=6,criterion='gini')
clf_QP_22.fit_tree()
...
clf_QP_27 = Classifier(data_QP_27, max_depth=8,splitter='best',min_samples_leaf=2,criterion='gini')
clf_QP_27.fit_tree()
...
clf_QP_32 = Classifier(data_QP_32, max_depth=6,splitter='best',min_samples_leaf=2,criterion='gini')
clf_QP_32.fit_tree()
...
clf_QP_37 = Classifier(data_QP_37, max_depth=2,splitter='best',min_samples_leaf=2,criterion='gini')
clf_QP_37.fit_tree()
